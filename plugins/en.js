export default {
  ...
  all: 'All',
  my: 'MY',
  this_section_is_not_active:"This Section is not active, please activate it to participate.",
  activate:"Activate",
  ...
  accept_term_and_condition: 'Accept Terms of <span class="primary-color">Service</span> and <span class="primary-color">Privacy Policy</span>',
  ...
  the_referral_system_and_the_profit_commissions: 'The Referral system has 25 levels and the profit commissions per level are displayed below:',
  ...
  the_referral_system_and_the_profit_commissions_description2: 'As long as your sponsored partners remain active within GYM NETWORK, you are earning commissions which is actually equal to a nice passive income stream. Help others make profits with DeFi and earn passive income for doing so.',
  ...
  you_dont_receive_pending_rewards_for_deposit_without_locking_period: 'You do not receive pending rewards for a deposit without a locking period',
  lpTokensWillBeAutomaticallyStakedOnTheFaringContract: "LP tokens will be automatocally staked on the farming contract.",
  depositFeeForBuyAndBurn: "4% Deposit Fee for Buy and Burn",
  unlock: "Unlock",
  halfOfYourGymNetTokensWillBeUsed: "Half of your GYMNET tokens will be used to buy BNB, then pooled and staked on the staking contact.",
  halfOfYourBnbTokensWillBeUsed: "Half of your BNB tokens will be used to buy GYMNET, then pooled and staked on the staking contact.",
  halfOfYourBusdTokensWillBeUsed: "Half of your BUSD tokens will be used to buy GYMNET, then pooled and staked on the staking contact.",
  removeLiquidity: "Remove liquidity",
  pooled: "Pooled",
  unstake: "Unstake",
  lpTokensWillBeInYourWallet: "LP tokens will be in your wallet. To get your tokens, click the button “Remove liquidity” after completing this action",
  dailyProfit: "Daily profit",
  withdraw_and_claim: "Withdraw & Claim",
  pending_GYMNET_reward: "Pending GYMNET reward",
  LP_tokens_will_be_in_your_wallet: "LP tokens will be in your wallet. To get your tokens, click the button “Remove liquidity” after completing this action",
  ...
  you_will_receive_commissions_text: "You will receive commissions on your downline and will be qualified according to the rank conditions",
  ...
  header_description: 'We give you access to the best DeFi returns. The hard work is on us, you just get the results.',
  total_burnt: 'Total burnt',
  gymnet_price: 'GYMNET price',
  total_supply: 'Total supply',
  total_value_locked: 'Total value locked',
  tvl: 'TVL',
  listed_on: 'GYMNET is listed on',
  listed_on_title: 'GYMNET is listed on',
  investment_system_title: "Gym Network — A DeFi Aggregator Investment System",
  investment_system_description: 'GYM Network is a DeFi Aggregator Investment System that combines the best yields with high rewards for its users. Thus providing easy access and saving you a lot of precious time. Imagine getting the best yields in the DeFi space directly into your wallet. Now the time has come to let your dreams become reality!',
  go_to_the_products: 'Go to the products',
  gymstreet_title: 'GYM Street — The Metaverse ',
  gymstreet_description: 'A place where we can do anything! We create GYM Street as the future of our daily life. Work, finance, shopping, communication, real estate, sum up a new life in the Metaverse. Discover your unimagined potential and design your new life in the Metaverse with GYM Street.',
  go_to_gymstreet: 'Go to GYM Street',
  metaverse_desc: '“We see a world where everyone is a part of the digital future and can shape their own financial freedom as an investor. Driven by our passion for Blockchain, DeFi and Metaverse, we are creating the solutions of tomorrow”.',
  protection_tools: 'Protection Tools',
  price_stabilizer: 'Price Stabilizer',
  stabilizer_desc: '10% of the profits from the Vault are used for the Buy Back & Burn program.',
  ...
  affiliate_system_info: 'With GYM Network\'s affiliate system, you can build your own crypto referral business and long-term passive income.',
  affiliate_desc: 'Become a part of the GYM Network community today and create your own financial freedom.',
  read_more: 'Read more',
  roadmap_title: 'GYM Network Roadmap',
  roadmap_desc: 'Our vision for the future and what we have implemented to date',
  ...
  terms_condition_text: '<p><b>Master Tipster Contract</b></p>\n' +
    '<p>Between</p>\n' +
    '\n' +
  ...
  terms_condition_accept_info: 'After accept T&C, you will not be able to change it later and will implement automatically.',
  ...
  you_successfully_accepted_terms_conditions: "You successfully accepted Terms & Conditions",
  to_dashboard: "To dashboard",
  you_will_receive_your_tokens_text: "You will receive your Tokens in Wrapped BNB, please import WBNB to your wallet to see your funds.",
  you_will_receive_your_tokens_text_BUSD: "You will receive your Tokens in BUSD, please import BUSD to your wallet to see your funds.",
  share_of_NFT_pool: "Share of NFT pool",
  partner_area: "Partner Area",
  rockstar_rank_text: "The rockstars are an additional qualification option, which allows everybody to qualify for three different ranks in an easier way. ",
  ...
  reach_levels_much_easier_text: 'You can pay 4% buy and burn fee now and reach levels in the future under the new conditions. Offer valid for 30 days after the confirmation T&C confirmation.',
  rockstar_10_rank: 'Rockstar 10 Rank',
  rockstar_10_rank_text: 'You will only need 7500 USD instead of 20000 USD in all deposits. Also you will need smaller deposit for 9 rank. No qualified partner requirements.',
  ...
  rockstar_24_rank_text: 'You will only need  100000 USD instead of 135000 USD in all deposits. No qualified partner requirements.',
  rockstar_23_rank: 'Rockstar 23 Rank',
  rockstar_23_rank_text: 'You will only need  90000 USD instead of 120000 USD in all deposits. Also you will need smaller deposit for 21, 22 rank. No qualified partner requirements.',
  swap: "Swap",
  member: "Member",
  buy: "Buy",
  ...
  connect_your_wallet_desc: 'to the website and make your first deposit into the Vault (from 0.051 BNB)',
  ar_app_desc: 'Augmented reality meets blockchain! Train in a virtual GYM while earning rewards for completing exercises',
  ar_app: 'AR APP',
  ntf_marketplace_desc: 'Invest, collect and trade valuable NFTs on zuckerland.io, the NFT marketplace.',
  ntf_marketplace: 'NFT Marketplace',
  play_earn_desc: 'Play online games and earn rewards, like the No-Loss Lottery, an absolutely unique DeFi-based lottery',
  play_earn: 'Play & Earn',
  launchpad_desc: 'Be among the first to get access to new projects before they hit the market',
  launchpad: 'Launchpad',
  earn_crypto_desc: 'Earn attractive returns on Bitcoin, ETH, BNB, DOGE, Stablecoins and more.',
  earn_crypto: 'Earn Crypto',
  gymnet_vault_desc: 'Earn the best interest in the most popular crypto assets and receive unique token rewards  ',
  gymnet_vault: 'Gymnet Vault',
  metaverse: 'Metaverse',
  metaverse_slide_desc: 'Buy land to get exclusive access to all future products and use them in our virtual world\n',
  yield_farming_desc: 'Find the best and most lucrative farming deals in DeFi',
  yield_farming: 'Yield Farming',
  farming: 'Farming',
  farm_sp: '4% of the Farm & Single Pool ',
  farm_sp_desc: 'deposit goes into the buyback & burn program to counteracting inflation.',
  locking_sp: 'Locking in the single pool ',
  locking_sp_desc: 'reduces the GYMNET in circulation, which helps stabilize the price over the long term.',
  burning_gymnet: 'Burning GYMNET',
  burning_gymnet_desc: 'through buyback & burn will result in an increase in the GYMNET price and a decreased sale of the token. ',
  through_codetermination_rights: 'Through co-determination rights,',
  through_codetermination_rights_desc: 'the community has a direct impact on the future of GYM Network. ',
  ...
  what_dao_desc: 'A decentralized autonomous organization (DAO) is a software running on a blockchain that offers users a built-in model for the collective management of its code.\n' +
    '\n' +
  ...
  what_dao_governance_desc: 'DAO governance is coordinated using tokens or NFTs that grant voting powers. Admission to a DAO is limited to people who have a confirmed ownership of these governance tokens in a cryptocurrency wallet, and membership can be exchanged. Governance is conducted through a series of proposals that members vote on through the blockchain, and the possession of more governance tokens often translates to greater voting power.',
  how_use_network: 'How can I use GYM NETWORK?',
  how_use_network_desc: 'You can use it as a Vault, as a Single Farm, and as Liquidity Mining. So you have three ways to get more out of your tokens.\n' +
    'In parallel we are always working on the utility of the GYMNET Token. The more GYMNET Tokens you hold, the better access you get to future projects! See the Meta-networks.io roadmap. You will need GYMNET Token to get exclusive benefits and at the same time GYMNET Rewards.\n' +
    'In summary it means:\n' +
    'You can use GYM NETWORK as a DeFi platform and also as a constantly evolving metaverse. And of course, to make an affiliate career and earn lucrative commissions!',
  which_wallet_use_to_connect: 'Which wallets can I use to connect?',
  which_wallet_use_to_connect_desc: 'You can use Metamask, Truswallet and all offered wallets under the item WALLET CONNECT.',
  what_apy_apr: 'What is APY and APR?',
  what_apy_apr_desc: 'APR represents the annual rate charged for earning or borrowing money.\n' +
  ...
  where_rewords_vaults_come_from_desc: '\n' +
    'Each Vault is connected to a well-known and already established DeFi protocol. In this case, the BNB/GYMNET Vault is connected to the Alpaca platform.\n' +
    '\n' +
    'There, for example, users can borrow money against an interest.\n' +
    '\n' +
    'This interest is the return for you as a user and comes from there.\n' +
    '\n' +
    'In addition, you get GYMNET tokens as a reward from our platform. This gives you an unbeatable advantage over users who use e.g. Alpaca directly without GYM NETWORK!\n' +
    '\n' +
  ...
  who_what_alpaca_desc: 'Alpaca Finance is the largest lending protocol allowing leveraged yield farming on Binance Smart Chain. It helps lenders earn safe and stable yields, and offers borrowers undercollateralized loans for leveraged yield farming positions, vastly multiplying their farming principals and resulting profits.',
  ...
  what_do_with_gymnet_desc: 'The more GYMNET Tokens you hold, the better access you get to future projects! See the Meta-networks.io roadmap. You will need GYMNET Token to get exclusive benefits and at the same time GYMNET Rewards.\n' +
    '\n' +
    'The use cases are:\n' +
    '\n' +
    'You can use GYM NETWORK and its Reward Token GYMNET as a DeFi platform in the VAULT, the Single Farm, and for Liquidity Mining, as well as a constantly evolving metaverse.',
  ...
  how_affiliate_work_desc: 'The affiliate system works directly through your wallet. Each wallet must be linked to a Telegram account when you sign up (only by invitation with an affiliate link). This is important for support requests and much more!\n' +
    '\n' +
    'After that you will be assigned your own affiliate link which you can use to become a member. If someone now signs up and invests in the Vault and gets rewards, you also get "passive" commissions.\n' +
    '\n' +
    'So whenever your referred investor (you have a referrer status) decides to use GYM NETWORK and gets his first VAULT rewards, you will get a commission. Over and over again, as long as the user leaves his investment in the Vault.\n' +
    '\n' +
    'This way you can build up a lucrative passive income.\n' +
    '\n' +
    'The affiliate system has a total of 16 levels and other highlights that will help you get started as a tipster! Take a look at the webinars or the presentation PDF or contact your sponsor for more details.',
  paginationText: "Showing {from} - {to} of {count}",
  desktop_tooltip: 'Summary of all your available investments, in widget cards.',
  total_vaults_deposit_tooltip: 'Total Dollar value of deposits in all available Vaults',
  total_income_tooltip: 'Total Dollar Value Income since beginning from Vaults,Single Pool, Farms',
  gymnet_earned_tooltip: 'Total GYMNET rewards received since beginning from Vaults, Single Pool, Farm',
  you_have_tokens_text: 'You have {n} of GYM V1.5 tokens, we recommend you to swap it to new ones by clicking the button below',
  ...
  turnover_rule_desc: 'The maximum share each direct can contribute to the required turnover is up to 50%',
  affiliate_terms_condition_text: '<p><h6>Ethical Rules (I.) and General Tipster Conditions (II.)</h6></p>\n' +
    '\n' +
  ...
  available_commissions_tooltip: 'Allows to claim of the NFT commissions (BNB/BUSD)',
  ...
  NFTRewardsAreNotAvailableThisRank: "NFT Rewards are not available on this rank",
  rookieBasic: "Basic",
  rookieBasicText: "The rockstars are an additional qualification option, which allows",
  rookiePro: "PRO",
  rookieProText: "The rockstars are an additional qualification option, which allows",
  ...
  welcomeToPartnerAreaText: "Since you came from Gymstreet you’re already qualified for level 3 - Rookie II. In order to be qualified for next level 4 you have to join Gymnetwork and make deposits.",
  ...
  // new translations
  myStakeTextForVBTC: "Here you can deposit your VBTC tokens to earn more rewards",
  halfOfYourVBTCTokensWillBeUsed: "Half of your VBTC tokens will be used to buy BUSD, then pooled and staked on the staking contact.",
  halfOfYourBusdTokensWillBeUsedVBTC: "Half of your BUSD tokens will be used to buy VBTC, then pooled and staked on the staking contact.",
  ...
  you_should_deposit_in_vault: 'You should deposit at least $25 in one of the vaults, to be allowed to make deposits in other products like farms and single pool.',
  you_should_be_allowed_to_deposit_single_pool:'You should deposit at least $25 in one of the vaults, to be allowed to make deposit in single pool',
  you_should_be_allowed_to_deposit_farming:'You should deposit at least $25 in one of the vaults, to be allowed to add liquidity in farming',
