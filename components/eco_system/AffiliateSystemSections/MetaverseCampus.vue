<template>
  <div class="section containe text-light py-5">
    <h4 class="NavigationName d-lg-none">
      <span class="rounded-circle me-2"></span> {{ content.metaverse_campus }}
    </h4>
    <div class="content d-md-flex align-items-center my-5">
      <div class="text col-md-8 pe-md-3">
        <h1 class="my-4">{{ content.metaverse_campus_title }}</h1>
        ...
        <div
          class="paragraph py-3"
          v-html="content.metaverse_campus_desc"
        ></div>
        <nuxt-link
          to=""
